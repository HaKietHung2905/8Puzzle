...
\begin{figure}[!htbp]
  \begin{center}
    \leavevmode
    \ifpdf
      \includegraphics[height=3in]{Start}
    \else
      \includegraphics[bb = 92 86 545 742, height=3in]{Start}
    \fi
    \caption{Bước 1}
    \label{FigAir}
...
\begin{figure}[!htbp]
  \begin{center}
    \leavevmode
    \ifpdf
      \includegraphics[height=3in]{Step1}
    \else
      \includegraphics[bb = 92 86 545 742, height=3in]{Step1}
    \fi
    \caption{Bước 1}
    \label{FigAir}
...
\begin{figure}[!htbp]
  \begin{center}
    \leavevmode
    \ifpdf
      \includegraphics[height=5in]{Step2}
    \else
      \includegraphics[bb = 92 86 545 742, height=5in]{Step2}
    \fi
    \caption{Bước 2}
    \label{FigAir}
